    ...
    <div className="App">
      ...
      <main>
        <div className="bar-container">
          <div className="bar" style={{width: `${calculeteProgress()}%`}}></div>
        </div>
        ...
        <button onClick={handleClick} disabled={calculeteProgress() !== 100}>Enviar Formulário</button>
      </main>
    </div>
  );
}
